			...
			<div class="col-md-9">
				<div class="thumbnail">
					...
					<div class="caption-full">
						...
						<c:if test="${user != null}">
							<a class="btn btn-info" href="/hotelbook/?id='${requestScope.hotel.getId()}'">Book</a>
						</c:if>
						<c:if test="${user.getType() == 'Admin'}">
							<a class="btn btn-danger" href="/hoteldelete/?id='${requestScope.hotel.getId()}'">Delete</a>
							<a class="btn btn-warning" href="/hotelupdate/?id='${requestScope.hotel.getId()}'">Update</a>
						</c:if>
					</div>
				</div>
			</div>
